...
const Signup = () => {
    ...
    const handleSignup = (event) => {
        ...
        if (password !== confirmPassword) {
            setErrorMessage("Password do not match! Please provide a correct password!")
        } else{
            setErrorMessage("");
                ...
                <div className="container">
                    <div className="account-wrapper">
                        ...
                        <form className='account-form' onSubmit={handleSignup}>
                            ...
                            <div className="form-group">
                                <input type="password" name='confirmPassword' id='confirmPassword' placeholder='Cofirm Password' required />
